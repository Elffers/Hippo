...
Product.create(
  user_id: 1,
  name: "blue shirt",
  photo: "http://bit.ly/19zrTF9",
  price: 19.99,
  description: "Pretty and blue",
  retired: false,
  inventory: 12
  )
...
Product.create(
  user_id: 1,
  name: "green shirt",
  photo: 'http://upload.wikimedia.org/wikipedia/commons/4/48/Hippo_mouth.jpg',
  price: 19.99,
  description: "Pretty and green",
  retired: false,
  inventory: 12
  )
...
Product.create(
  ...
  photo: 'http://upload.wikimedia.org/wikipedia/commons/4/48/Hippo_mouth.jpg',
  price: 19.99,
  description: "Pretty and rainbow",
  retired: false,
  inventory: 12
  )
...
Product.create(
  ...
  photo: 'http://upload.wikimedia.org/wikipedia/commons/4/48/Hippo_mouth.jpg',
  price: 100.99,
  description: "spacious and good for writing",
  retired: false,
  inventory: 12
  )
...
Product.create(
  ...
  photo: 'http://upload.wikimedia.org/wikipedia/commons/4/48/Hippo_mouth.jpg',
  price: 1.99,
  description: "good at writing in blue",
  retired: false,
  inventory: 12
  )
...
Product.create(
  ...
  photo: 'http://upload.wikimedia.org/wikipedia/commons/4/48/Hippo_mouth.jpg',
  price: 1.99,
  description: "good at writing in green",
  retired: false,
  inventory: 12
  )
...
Product.create(
  ...
  photo: 'http://upload.wikimedia.org/wikipedia/commons/4/48/Hippo_mouth.jpg',
  price: 1.99,
  description: "good at writing in black",
  retired: false,
  inventory: 12
  )
...
Product.create(
  ...
  photo: 'http://upload.wikimedia.org/wikipedia/commons/4/48/Hippo_mouth.jpg',
  price: 1.99,
  description: "good at writing in red",
  retired: false,
  inventory: 12
  )
...
Product.create(
  ...
  photo: 'http://upload.wikimedia.org/wikipedia/commons/4/48/Hippo_mouth.jpg',
  price: 1.99,
  description: "good at writing in purple",
  retired: false,
  inventory: 12
  )
...
Product.create(
  ...
  photo: 'http://upload.wikimedia.org/wikipedia/commons/4/48/Hippo_mouth.jpg',
  price: 1.99,
  description: "good at fixing writing in blue",
  retired: false,
  inventory: 12
  )
...
Product.create(
  ...
  photo: 'http://upload.wikimedia.org/wikipedia/commons/4/48/Hippo_mouth.jpg',
  price: 12.99,
  description: "good for practicing",
  retired: false,
  inventory: 12
  )
...
Product.create(
  user_id: 5,
  name: "last year's test",
  photo: 'http://upload.wikimedia.org/wikipedia/commons/4/48/Hippo_mouth.jpg',
  price: 12.99,
  description: "used to be good for learning",
  retired: true,
  inventory: 12
  )
